...
import { X, Store, Utensils, Clock, DollarSign, Image as ImageIcon, Check, ChevronRight, ChevronLeft, Sparkles } from 'lucide-react';
      ...
      {isOpen && (
        <div className="fixed inset-0 z-[70] flex items-center justify-center p-4">
          ...
          <motion.div
            ...
            className="relative w-full max-w-2xl bg-surface rounded-[3rem] border border-white/10 shadow-2xl overflow-hidden"
          >
            {/* Progress Bar */}
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="grid grid-cols-2 gap-4 mt-2">
                        <div className="space-y-1">
                          <label className="text-[10px] font-bold uppercase tracking-widest text-white/60">Latitude</label>
                          <input 
                            type="number"
                            step="any"
                            value={formData.lat}
                            ...
                            className="w-full bg-white/5 border border-white/10 rounded-xl py-2 px-4 text-white focus:ring-2 focus:ring-primary outline-none transition-all text-sm"
                          />
                        </div>
                        <div className="space-y-1">
                          <label className="text-[10px] font-bold uppercase tracking-widest text-white/60">Longitude</label>
                          <input 
                            type="number"
                            step="any"
                            value={formData.lng}
                      ...
                      <p className="text-[10px] text-white/30 italic mt-1">Used for calculating delivery distance and time. Accurate coordinates help drivers find you.</p>
                    </div>
                  </motion.div>
                )}
              ...
              <div className="flex gap-4 mt-12">
                ...
                {step < 3 ? (
                  <button
                    ...
                    className="flex-[2] py-5 rounded-2xl font-black flex items-center justify-center gap-2 bg-primary text-white hover:scale-[1.02] active:scale-[0.98] transition-all shadow-xl shadow-primary/20 disabled:opacity-50 disabled:scale-100"
                  >
